...
export const DOMAIN = "https://yogeshbisht-cwy-egxp.vercel.app";

export const metadata: Metadata = {
  metadataBase: new URL(DOMAIN),
  title: "Yogesh Bisht | Full-Stack Software Developer ",
  description:
  ...
  openGraph: {
    ...
    firstName: "Yogesh",
    lastName: "Bisht",
    username: "codewithyash",
    gender: "male",
    locale: "en_US",
    url: DOMAIN,
    title: "Yogesh Bisht | Full-Stack Software Developer & Interface Architect",
    description:
      "Discover the portfolio of Yogesh Bisht, a software developer specializing in crafting beautiful web applications with React, Next.js & TypeScript. View projects demonstrating clean code, accessibility & stunning UIs.",
    siteName: "Yogesh Bisht| Developer Portfolio",
    images: [
      {
        url: `${DOMAIN}/og.png`,
        width: 1200,
        height: 630,
        alt: "Yogesh Bisht - Software Developer Portfolio featuring React and Next.js projects",
      },
    ],
  },
  twitter: {
  ...
  verification: {
    ...
    other: {
      me: ["mailto:yogeshbisht12122005@gmail.com", "https://github.com/YogeshBisht12"],
    },
  },
  alternates: {
    canonical: DOMAIN,
  ...
  appleWebApp: {
    ...
    title: "Yogesh Bisht | Developer Portfolio",
    startupImage: [
      {
  ...
  applicationName: "Yogesh Bisht | Developer Portfolio",
  formatDetection: {
    telephone: false,
    address: false,
    email: false,
